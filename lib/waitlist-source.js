...
//
// The utm values below must match the "GMP Link Tracker" sheet, UTM tab
// (columns F "medium", G "campaign", H "content"). That sheet is the source
// of truth for every link we hand out.
//
// TO ADD A NEW FREEBIE OR PLACEMENT: create the tag in Kit, add its id to
// WL_FROM_TAGS, and add the link's utm_content to BY_CONTENT (or its campaign
// to BY_CAMPAIGN when several links share one utm_content).
...
export const WL_FROM_TAGS = {
  ...
  'essay-six-middle-skills': 23848772,
  'collapsing-cruelty': 23798643,
  bio: 23798433,
  story: 23798645,
  popup: 23798647,
  banner: 23798435,
...
const BY_CONTENT = {
  ...
  'collapsing-cruelty-manychat': 'collapsing-cruelty',
  ...
  'six-middle-skills-essay': 'essay-six-middle-skills',
  // The Autopilot banner under each essay's byline has its own utm_content
  // (so banner vs bottom-button clicks can be compared) but counts toward the
  // same essay tag.
  'capable-essay-banner': 'essay-capable',
  'five-minute-meeting-essay-banner': 'essay-five-minute-meeting',
  'collapsing-cruelty-essay-banner': 'essay-collapsing-cruelty',
  'six-middle-skills-essay-banner': 'essay-six-middle-skills',
  link_in_bio: 'bio',
  banner: 'banner',
};

// A freebie's own campaign, for links whose utm_content is shared across
// freebies (the Kit delivery emails all use utm_content=delivery-email).
const BY_CAMPAIGN = {
  'freebie-capable': 'capable',
  'freebie-five-minute-meeting': 'script',
  'freebie-collapsing-cruelty': 'collapsing-cruelty',
};
...
export function waitlistSourceKey(fields) {
  ...
  const byCampaign = look(BY_CAMPAIGN, norm(fields?.utm_campaign));
